...
def qr_detection_thread():
    ...
    while global_state.running:
        if global_state.frame is not None and not global_state.process_qr:
            print("Checking for QR code in the current frame.")
            ...
            if qr_data:
                ...
                try:
                    print(f"Speaking: {qr_data}")
                    speaker.say(qr_data)
                    speaker.runAndWait()
                    print(f"Finished speaking: {qr_data}")
                except Exception as e:
                    print(f"Error in speaking QR data: {e}")
...
def handle_user_interaction():
    ...
    while global_state.nlp:
        try:
            print("Speaking: Do you have any questions, Yes or No?")
            speaker.say("Do you have any questions, Yes or No ?")
            speaker.runAndWait()
            print("Finished speaking: Do you have any questions, Yes or No?")
            ...
            if user_question is None:
                print("Speaking: I didn't quite get it. Please repeat.")
                speaker.say("I didn't quite get it. Please repeat.")
                speaker.runAndWait()
                print("Finished speaking: I didn't quite get it. Please repeat.")
                continue
            ...
            speaker.runAndWait()
            print(f"Finished speaking: {ai_response}")
        except Exception as e:
            print(f"Error in handle_user_interaction: {e}")
...
if __name__ == "__main__":
    try:
        create_museum_json()
        print("Speaking: Hello, I am Nitro, your museum assistant, we will start the tour now.")
        speaker.say("Hello, I am Nitro, your museum assistant, we will start the tour now.")
        speaker.runAndWait()
        print("Finished speaking: Hello, I am Nitro, your museum assistant, we will start the tour now.")
